...
var ProductRow = function (_Component2) {
    _inherits(ProductRow, _Component2);
...
var ProductTable = function (_Component3) {
    _inherits(ProductTable, _Component3);
...
var FilterableProductTable = function (_Component5) {
...
var PRODUCTS = [{ category: 'RTV', price: '1500 zł', stocked: true, name: 'Telewizor 43 cale' }, { category: 'RTV', price: '1800 zł', stocked: true, name: 'Zestaw kina domowego' }, { category: 'RTV', price: '350 zł', stocked: false, name: 'Radioodtwarzacz' }, { category: 'AGD', price: '50 zł', stocked: true, name: 'Suszarka do włosów' }, { category: 'AGD', price: '350 zł', stocked: false, name: 'Odkurzacz' }, { category: 'AGD', price: '70 zł', stocked: true, name: 'Waga łazienkowa' }];
